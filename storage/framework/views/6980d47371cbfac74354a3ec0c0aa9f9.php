                    ...
                    <div class="card bg-comman w-100">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                ...
                                <div class="db-icon">
                                    <img src="<?php echo e(URL::to('assets/img/icons/student-icon-01.svg')); ?>" alt="Dashboard Icon">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card bg-comman w-100">
                        <div class="card-body">
                            <div class="db-widgets d-flex justify-content-between align-items-center">
                                ...
                                <div class="db-icon">
                                    <img src="<?php echo e(URL::to('assets/img/icons/student-icon-02.svg')); ?>" alt="Dashboard Icon">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="dash-details">
                                        <div class="lesson-activity">
                                            <div class="lesson-imgs">
                                                <img src="<?php echo e(URL::to('assets/img/icons/lesson-icon-01.svg')); ?>" alt="">
                                            </div>
                                        ...
                                        <div class="lesson-activity">
                                            <div class="lesson-imgs">
                                                <img src="<?php echo e(URL::to('assets/img/icons/lesson-icon-02.svg')); ?>" alt="">
                                            </div>
                                            <div class="views-lesson">
                                                <h5>Lessons</h5>
                                                <h4>5 Lessons</h4>
                                        ...
                                        <div class="lesson-activity">
                                            <div class="lesson-imgs">
                                                <img src="<?php echo e(URL::to('assets/img/icons/lesson-icon-03.svg')); ?>" alt="">
                                            </div>
                                            <div class="views-lesson">
                                                <h5>Time</h5>
                                                <h4>Lessons</h4>
                                ...
                                <div class="col-lg-3 col-md-3">
                                    <div class="dash-details">
                                        <div class="lesson-activity">
                                            <div class="lesson-imgs">
                                                <img src="<?php echo e(URL::to('assets/img/icons/lesson-icon-04.svg')); ?>" alt="">
                                            </div>
                                            <div class="views-lesson">
                                                <h5>Asignment</h5>
                                                <h4>5 Asignment</h4>
                                        ...
                                        <div class="lesson-activity">
                                            <div class="lesson-imgs">
                                                <img src="<?php echo e(URL::to('assets/img/icons/lesson-icon-05.svg')); ?>" alt="">
                                            </div>
                                            <div class="views-lesson">
                                                <h5>Teacher</h5>
                                                <h4>John Doe</h4>
                                        ...
                                        <div class="lesson-activity">
                                            <div class="lesson-imgs">
                                                <img src="<?php echo e(URL::to('assets/img/icons/lesson-icon-06.svg')); ?>" alt="">
                                            </div>
                                            <div class="views-lesson">
                                ...
                                <div class="card-body">
                                    <div class="teaching-card">
                                        ...
                                        <ul class="activity-feed">
                                            ...
                                            <li class="feed-item d-flex align-items-center">
                                                <div class="dolor-activity">
                                                    <span class="feed-text1"><a>Botany</a></span>
                                                    <ul class="teacher-date-list">
                                                        <li><i class="fas fa-calendar-alt me-2"></i>September 5,
                                                            2022</li>
                                                        <li>|</li>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\FIKRI\Downloads\kuliah\ABP\tubes\laravel\edited school system\resources\views/dashboard/student_dashboard.blade.php ENDPATH**/ ?>