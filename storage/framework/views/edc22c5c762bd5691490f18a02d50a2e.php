...
<script type="text/javascript">
    $(document).ready(function() {
       $('#UsersList').DataTable({
            ...
            searching: true,
            ajax: {
                url:"<?php echo e(route('get-users-data')); ?>",
            },
            columns: [
                {
                    data: 'user_id',
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\FIKRI\Downloads\kuliah\ABP\tubes\laravel\edited school system\resources\views/usermanagement/list_users.blade.php ENDPATH**/ ?>