                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    ...
                                    <a href="<?php echo e(route('department/add/page')); ?>" class="btn btn-primary">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="modal-btn delete-action">
                    <div class="row">
                        <form action="<?php echo e(route('department/delete')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script type="text/javascript">
        ...
        $('#dataList').DataTable({
                ...
                searching: true,
                ajax: {
                    url:"<?php echo e(route('get-data-list')); ?>",
                },
                columns: [
                    {
                        data: 'department_id',
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\FIKRI\Downloads\kuliah\ABP\tubes\laravel\edited school system\resources\views/department/list-department.blade.php ENDPATH**/ ?>