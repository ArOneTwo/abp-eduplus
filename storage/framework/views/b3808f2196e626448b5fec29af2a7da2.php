                ...
                <div class="profile-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col ms-md-n2 profile-user-info">
                            ...
                            <div class="user-Location"><i class="fas fa-map-marker-alt"></i> West Java, Bekasi </div>
                            <div class="about-text">Bekasi 071</div>
                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <p class="col-sm-9">20 Maret 2003</p>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <p class="col-sm-9 mb-0">Bekasi</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <button class="btn btn-success" type="button"><i class="fe fe-check-verified"></i> <?php echo e(Session::get('status')); ?></button>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\FIKRI\Downloads\kuliah\ABP\tubes\laravel\edited school system\resources\views/dashboard/profile.blade.php ENDPATH**/ ?>