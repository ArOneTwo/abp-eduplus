        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col"></div>
                    <div class="col-auto">
                        <a href="<?php echo e(route('invoice/list/page')); ?>" class="invoices-links active">
                            <i class="fa fa-list" aria-hidden="true"></i>
                        </a>
                        <a href="<?php echo e(route('invoice/grid/page')); ?>" class="invoices-links">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-8 col-md-8">
                                <div class="invoices-tabs">
                                    <ul>
                                        <li><a class="active" href="<?php echo e(route('invoice/list/page')); ?>">All Invoice</a></li>
                                        <li><a href="<?php echo e(route('invoice/paid/page')); ?>">Paid</a></li>
                                        <li><a href="<?php echo e(route('invoice/overdue/page')); ?>">Overdue</a></li>
                                        <li><a href="<?php echo e(route('invoice/draft/page')); ?>">Draft</a></li>
                                        <li><a href="<?php echo e(route('invoice/recurring/page')); ?>">Recurring</a></li>
                                        <li><a href="<?php echo e(route('invoice/cancelled/page')); ?>">Cancelled</a></li>
                                    </ul>
                                </div> 
                            </div>
                        ...
                        <div class="card-body">
                            <div class="inovices-widget-header">
                                <span class="inovices-widget-icon">
                                    <img src="<?php echo e(URL::to('assets/img/icons/invoices-icon1.svg')); ?>" alt="">
                                </span>
                ...
                <div class="col-xl-3 col-sm-6 col-12">
                    <div class="card inovices-card">
                        <div class="card-body">
                            <div class="inovices-widget-header">
                                <span class="inovices-widget-icon">
                                    <img src="<?php echo e(URL::to('assets/img/icons/invoices-icon2.svg')); ?>" alt="">
                                </span>
                                <div class="inovices-dash-count">
                ...
                <div class="col-xl-3 col-sm-6 col-12">
                    <div class="card inovices-card">
                        <div class="card-body">
                            <div class="inovices-widget-header">
                                <span class="inovices-widget-icon">
                                    <img src="<?php echo e(URL::to('assets/img/icons/invoices-icon3.svg')); ?>" alt="">
                                </span>
                                <div class="inovices-dash-count">
                ...
                <div class="col-xl-3 col-sm-6 col-12">
                    <div class="card inovices-card">
                        <div class="card-body">
                            <div class="inovices-widget-header">
                                <span class="inovices-widget-icon">
                                    <img src="<?php echo e(URL::to('assets/img/icons/invoices-icon4.svg')); ?>" alt="">
                                </span>
                                <div class="inovices-dash-count">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <a href="<?php echo e(url('invoice/edit/'.$value->invoice_id)); ?>" class="invoice-link"><?php echo e($value->invoice_id); ?></a>
                                            </td>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html">
                                                        <img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="<?php echo e(URL::to('/images/photo_defaults.jpg')); ?>" alt=""> <?php echo e($value->customer_name); ?>

                                                    </a>
                                                </h2>
                                            </td>
                                            <td class="text-primary">$ <?php echo e($value->total_amount); ?></td>
                                            <td><?php echo e(\Carbon\Carbon::parse($value->due_date)->format('d M Y')); ?></td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\FIKRI\Downloads\kuliah\ABP\tubes\laravel\school_system_laravel_10-main\resources\views/invoices/list_invoices.blade.php ENDPATH**/ ?>