...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(URL::to('assets/css/bootstrap-datetimepicker.min.cs')); ?>s">
    ...
    <link rel="stylesheet" href="<?php echo e(URL::to('assets/plugins/icons/feather/feather.css')); ?>">
        ...
        <div class="header">
            <div class="header-left">
                <a href="<?php echo e(route('home')); ?>" class="logo">
                    <img src="<?php echo e(URL::to('assets/img/logo.png')); ?>" alt="Logo">
                </a>
                <a href="<?php echo e(route('home')); ?>" class="logo logo-small">
                    <img src="<?php echo e(URL::to('assets/img/logo-small.png')); ?>" alt="Logo" width="30" height="30">
                </a>
            </div>
            ...
            <ul class="nav user-menu">
                <li class="nav-item dropdown noti-dropdown language-drop me-2">
                    <a href="#" class="dropdown-toggle nav-link header-nav-list" data-bs-toggle="dropdown">
                        <img src="<?php echo e(URL::to('assets/img/icons/header-icon-01.svg')); ?>" alt="">
                    </a>
                    <div class="dropdown-menu ">
                        <div class="noti-content">
                            <div>
                                <a class="dropdown-item" href="javascript:;"><i class="flag flag-lr me-2"></i>English</a>
                                <a class="dropdown-item" href="javascript:;"><i class="flag flag-id me-2"></i>Indonesia</a>
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown noti-dropdown me-2">
                    <a href="#" class="dropdown-toggle nav-link header-nav-list" data-bs-toggle="dropdown">
                        <img src="<?php echo e(URL::to('assets/img/icons/header-icon-05.svg')); ?>" alt="">
                    </a>
                                    ...
                                    <a href="#">
                                        <div class="media d-flex">
                                            <span class="avatar avatar-sm flex-shrink-0">
                                                <img class="avatar-img rounded-circle" alt="User Image" src="<?php echo e(URL::to('assets/img/logo-small.png')); ?>">
                                            </span>
                ...
                <li class="nav-item zoom-screen me-2">
                    <a href="#" class="nav-link header-nav-list win-maximize">
                        <img src="<?php echo e(URL::to('assets/img/icons/header-icon-04.svg')); ?>" alt="">
                    </a>
                </li>
                ...
                <li class="nav-item dropdown has-arrow new-user-menus">
                    <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                        <span class="user-img">
                            <img class="rounded-circle" src="/images/<?php echo e(Session::get('avatar')); ?>" width="31"alt="<?php echo e(Session::get('name')); ?>">
                            <div class="user-text">
                                <h6><?php echo e(Session::get('name')); ?></h6>
                    ...
                    <div class="dropdown-menu">
                        <div class="user-header">
                            <div class="avatar avatar-sm">
                                <img src="/images/<?php echo e(Session::get('avatar')); ?>" alt="<?php echo e(Session::get('name')); ?>" class="avatar-img rounded-circle">
                            </div>
                            <div class="user-text">
                                <h6><?php echo e(Session::get('name')); ?></h6>
                                <p class="text-muted mb-0"><?php echo e(Session::get('role_name')); ?></p>
...
</html><?php /**PATH C:\Users\FIKRI\Downloads\kuliah\ABP\tubes\laravel\edited school system\resources\views/layouts/master.blade.php ENDPATH**/ ?>